...
export default defineConfig({
	...
	webServer: {
		command:
			'rm -rf e2e/.data && env -u ORIGIN -u PROTOCOL_HEADER -u TMDB_API_KEY -u OMDB_API_KEY PV_DEMO_DATA= PV_INTERFACE_LANGUAGE= PV_CONFIG= PV_MEMBERS="Anna,Ben,Carla,David" PV_PIN=2611 DATA_DIR=e2e/.data PORT=4173 node build/index.js',
