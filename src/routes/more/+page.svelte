...
<div class="menu">
	...
	{/if}
	<a class="card" href="https://popcornvote.org" target="_blank" rel="noreferrer">
		🌐 {t('more.website')}
		<span class="muted">{t('more.websiteHint')}</span>
	</a>
	<a class="card" href="https://github.com/Stadicus/popcorn-vote" target="_blank" rel="noreferrer">
		🧑‍💻 {t('more.github')}
		<span class="muted">{t('more.githubHint')}</span>
	</a>
</div>
...
<p class="made-with">Made with ❤️ by Stadicus</p>
